...
## [0.5.3](https://github.com/RustyNova016/api_bindium/compare/v0.5.2...v0.5.3) - 2026-09-16

### Added

- allow overriding the max_tries of a specific request
- allow changing the incremental retry exponent
